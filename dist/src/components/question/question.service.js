...
var QuestionService = /** @class */ (function () {
    function QuestionService(questionModel) {
                        ...
                        redis_connection_1.redisClient.GET("questions", function (err, result) { return __awaiter(_this, void 0, void 0, function () {
                            ...
                            return __generator(this, function (_a) {
                                ...
                                if (result) {
                                    ...
                                    questions_1 = this.questionModel.query().select('title', 'text');
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.questionModel.query().insert(questionPayload)];
                    case 1:
                        questionId = _a.sent();
                        return [2 /*return*/, this.questionModel.query().findOne(questionId)];
                    case 2:
                        error_1 = _a.sent();
