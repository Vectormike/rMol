...
exports.AnswerControllerFactory = void 0;
var http_status_1 = __importDefault(require("http-status"));
var logger_1 = __importDefault(require("../../logger"));
function AnswerControllerFactory(answerService) {
    return {
        /**
         * Fetch all films
         */
        fetchAnswers: function (req, res, next) {
            return __awaiter(this, void 0, void 0, function () {
                var params, answers, error_1;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            _a.trys.push([0, 2, , 3]);
                            params = req.params;
                            return [4 /*yield*/, answerService.fetchAnswers(params.answerId)];
                        case 1:
                            answers = _a.sent();
                            logger_1.default.info(JSON.stringify(answers));
        ...
        createAnswer: function (req, res, next) {
            return __awaiter(this, void 0, void 0, function () {
                var params, body, user, answer, error_2;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                        ...
                        case 1:
                            _a.trys.push([1, 3, , 4]);
                            return [4 /*yield*/, answerService.createAnswer(params.questionId, body, { currentUser: user })];
                        case 2:
                            answer = _a.sent();
...
exports.AnswerControllerFactory = AnswerControllerFactory;
